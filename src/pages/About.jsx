  ...
  const journey = [
    {
      ...
      description:
        "1st year BCA AI-ML Student At Chitkara",
    },
    {
    ...
    },
    {
      ...
      description:
        "Developed and deployed 3+ production-ready applications spanning note-taking, URL shortening, AI tools and more.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className={`text-lg leading-relaxed ${textPrimary} mb-4`}>
            ...
            , I’m a passionate full-stack developer currently in my 1st year of my BCA (AI & ML) program at Chitkara University. My development journey began early, starting with core programming fundamentals and Data Structures & Algorithms, which built the strong foundation I rely on today. Over time, I expanded into MERN stack development, AI/ML exploration, Data Science, and even cybersecurity—constantly learning and pushing myself to create scalable, meaningful, and user-focused applications.
          </p>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className={`px-8 py-3 rounded-lg font-semibold border-2 transition-all duration-300 inline-flex items-center justify-center gap-2 ${isDark
