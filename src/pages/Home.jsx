  ...
  return (
    <div className={`${containerBg} min-h-screen transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-12 sm:pb-16 md:pb-24">
        ...
        {/* GRID: LEFT TEXT + RIGHT IMAGE + ROLES */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className={`text-base sm:text-lg leading-relaxed mb-8 ${textPrimary}`}>
              ...
              specializing in the{" "}
              <span className="font-semibold">MERN Stack</span>. Beyond coding, I
              explore <span className="font-semibold">AI/ML</span> and{" "}
              <span className="font-semibold">Data Science</span>, and love solving
          ...
          {/* RIGHT COLUMN → IMAGE + ROLES (kept together to maintain layout) */}
          <div className="flex flex-col items-center md:items-start gap-8">

            {/* HERO IMAGE WITH PERFECT SIZE */}
            <div
              className={`relative w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 
              rounded-2xl overflow-hidden border-4 ${isDark ? "border-blue-900/40" : "border-blue-200"
